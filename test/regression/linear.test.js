...
test('Linear Regression', function() {
  ...
  let gradW1 = grads[0];
  let gradb1 = grads[1];
  let learnRate = Learn4js.constant({name: 'learn_rate', data: [learning_rate], shape: [1, 1]});
  ...
  let sub1 = Learn4js.subtract({name: 'sub1', left: W, right: mul1});
  let sub2 = Learn4js.subtract({name: 'sub2', left: b, right: mul2});

  let assign1 = Learn4js.assign({name: 'assign1', target: W, value: sub1});
  let assign2 = Learn4js.assign({name: 'assign2', target: b, value: sub2});
